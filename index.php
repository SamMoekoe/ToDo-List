...
<body class="bg-dark">
    <div class="container img-thumbnail mt-3 mb-3">
        ...
        <?php foreach ($tasks as $task) { ?>
            ...
            ?>
                <a class="taskicons green fas fa-circle" style="color:green;"  href="StatusChange.php?id=<?php echo $task['id']?>&listid=<?php echo $task['listid']?>&name=<?php echo $task['name']?>&description=<?php echo $task['description']?>&status=<?php echo $task['status']?>"></a>
                
            <?php
            }else{
            ?>
                <a class="taskicons red fas fa-circle" style="color:red;"  href="StatusChange.php?id=<?php echo $task['id']?>&listid=<?php echo $task['listid']?>&name=<?php echo $task['name']?>&description=<?php echo $task['description']?>&status=<?php echo $task['status']?>"></a>
            <?php
            }
        ?>
